...
class DatabaseManager:
    ...
    def _init_collections(self):
        ...
        self.withdrawal_requests = self.bot_db['withdrawal_requests']  # ← 添加这一行
...
withdrawal_requests = db_manager.withdrawal_requests  # ← 添加这一行
# ✅ 库存通知管理优化
...
def get_agent_stats(agent_bot_id, period='all'):
    ...
    try:
        ...
        logging.info(f"✅ 获取代理统计成功：{agent_bot_id}, period={period}, orders={order_count}, sales={total_sales:.2f}")
        return result
